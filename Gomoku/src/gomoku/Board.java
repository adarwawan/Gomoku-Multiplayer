...
public class Board {
    ...
    /*public boolean canMove(int player, int absis, int ordinat){
    // cek apakah board tersebut di x,y telah diisi oleh player atau belum
        if(GameBoard[absis][ordinat] != 0)
            return true; 
        else
            return false; 
