...
public class Room {
    ...
    /* method */
    public Room (int _idRoom, String _roomname, int _playerMin, User _user) {
        idRoom = _idRoom;
        roomname = _roomname;
        playerMin = _playerMin;
    ...
    public void startGame () {
        board = new Board();
        board.setNumPlayer(playerMin);//set jumlah player
        status = 1;
        idTurn = 1;
    }
    ...
    public void setPlayerMin (int _playerMin) {
        playerMin = _playerMin;
    }
